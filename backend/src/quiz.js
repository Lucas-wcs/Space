const quiz = [
    ...
    },
    {
        ...
        "solution": "Jupiter",
        "commentaire-false": "Jupiter est, de loin, la plus grande planète du système solaire",
    ...
    },
    {
        ...
        "solution": "La Terre",
        "commentaire-false": "Tu es tombé dans le piège ! La Terre n'a qu'une seule lune !",
    ...
    },
    {
        ...
        "solution": "Mars",
        "commentaire-false": "Mauvaise réponse. Bon, c'est vrai, elle n'est pas totalement rouge...",
    ...
    {
        "id": "question-9",
        "question": "Combien de temps de voyage spatial depuis la Terre faut-il pour visiter Uranus ?",
        "reponse": [
            "9 jours",
            "9 mois",
            "9 ans",
    ...
    },
    {
        ...
        "commentaire-false": "Et en plus, il est trois fois plus gros que la Terre !",
        "commentaire-true": "Tu es un génie !"
    },
    {
        "id": "question-15",
        "question": "Quel est le corps céleste le plus brillant dans le ciel vu depuis la Terre ?",
        "reponse": [
            "La Lune",
            "Jupiter",
            "Mars",
    ...
    {
        "id": "question-16",
        "question": "Combien de jour met Mercure à faire un tour complet sur elle-même ?",
        "reponse": [
            "30 jours",
            "54 jours",
            "120 jours",
    ...
    {
        "id": "question-18",
        "question": "Si on pèse 45 kilos sur la Terre, combien de kilos pèserait-on sur Mars ?",
        "reponse": [
            "2 kilos",
            "17 kilos",
            "45 kilos",
    ...
    },
    {
        ...
        "solution": "Uranus",
        "commentaire-false": "La température moyenne est de -216° C ! On se les gêle !",
    ...
    },
    {
        ...
        "commentaire-false": "Sacrilège ! On dit bien pain au raison ? Non ? Bah voilà.",
